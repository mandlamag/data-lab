...
def visualize(schema: str, tx_id: str, illicit: bool, high_risk: bool, max_nodes: int):
    ...
    if tx_id:
        ...
        # Pick illicit nodes and expand with their direct neighbors (both directions)
        illicit_ids = [
            props["node_id"]
        ...
        # Start from a random illicit node, grow outward collecting neighbors
